{
  flake.nixosModules.app-starship = {...}: {
    my.hmModules = ["app-starship"];
  };

  flake.homeModules.app-starship = {lib, ...}: {
    programs.starship = {
      enable = true;
      ...
      settings = let
        ...
        to_display = percentage: {
          ...
          style = colors.battery.${toString percentage};
          discharging_symbol = symbols.battery.${toString percentage};
        };
